...
${bold('Installation')}
	deno install -f --allow-env=DENO_DIR,LOCALAPPDATA allow-net=raw.githubusercontent.com/Leokuma/wincompile --allow-read --allow-write --allow-run https://deno.land/x/wincompile@0.1.0/wincompile.ts
